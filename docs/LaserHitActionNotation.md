...
| ------------------------------------- | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`Deflector`**](Guide.md#deflector) | ![Laser Hit diagram for Deflector Piece](images/laser-v-pieces/laser_v_deflector.png) | The white mirrored side of the `deflector` deflects the laser 90 degrees. Its non-mirrored sides simply stop the laser and the piece remains in play.                 |
